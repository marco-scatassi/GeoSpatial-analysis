...
def retrieve_database_and_collections(
    db_name: str, day: str, which: list, connection_string="mongodb://localhost:27017"
):
    # Get the database
    ...
    # Get the collections
    collections = {
        collection_name: db[collection_name] for collection_name in collections_names
    }
